...
Reads dashboards/openpaw-overview.json and creates or updates the dashboard
...
def main():
    ...
    dashboard_path = Path(__file__).resolve().parent.parent / "dashboards" / "openpaw-overview.json"
