...
Reads monitors/openpaw-monitors.json and creates or updates each monitor
...
def main():
    ...
    monitors_path = Path(__file__).resolve().parent.parent / "monitors" / "openpaw-monitors.json"
