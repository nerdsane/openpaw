...
/// Create a new TemperFS File entity and write content to it.
/// Returns the file entity ID on success.
pub fn create_content_file(
    ...
    let file_parsed: serde_json::Value = serde_json::from_str(&file_resp.body)
...
/// Read content from a TemperFS File entity by its ID.
