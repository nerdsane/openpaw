...
for module in computer_exec computer_exec_start computer_exec_poll computer_copy_start computer_copy_poll computer_copy_lock_poll computer_terminate; do
