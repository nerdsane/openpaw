...
control-plane identifier, worker mode, Datadog evidence, and terminal-success
gates. The script did not build the worker, read metadata, create a live
episode, start a local worker, poll episode entities, or query Datadog.
