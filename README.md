...
3. **End-to-end app lifecycle** — once agents can submit specs + write files, test the full cycle: agent designs an app → submits specs → governance approves → app installs → agent uses it. LLM Wiki ([Karpathy pattern](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f)) is the first candidate.
