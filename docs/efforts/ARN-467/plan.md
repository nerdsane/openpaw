...
2. Define the operational model and generate matching CSDL, formal model and invariant tests from the same schema. Add stable resource/flow/participant identities and seeded DSF bindings. Prove invalid transitions and stale/replayed observations fail before implementing integrations.
